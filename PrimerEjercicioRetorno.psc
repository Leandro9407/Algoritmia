//Si el sueldo es mayor 3.000.000 se hace el 12% de descuento si es ingeniero, el 8% si es operario. 
//Se le descuenta del salario 2% por salud, 3% por pension sin importar el cargo.
